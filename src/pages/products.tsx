  ...
  <div className="flex flex-row items-center p-4">
   {products ? (
    products.map((product) => (
     <div className=" border-white border shadow-lg shadow-pink-500/50 border-solid rounded-md flex flex-col items-center gap-5 mx-4">
      <img
       className="w-48 h-48 rounded mt-4"
       src={product.attributes.image}
       alt="product"
      />
      <div className="text-pink-300 px-2">
